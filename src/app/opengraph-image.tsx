...
export const alt = "Poshkan — paper trading with your own strategies and virtual money.";
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: 28, fontSize: 30, color: "rgba(255,255,255,0.75)", lineHeight: 1.4 }}>
            Build and backtest your own strategies — stocks, crypto and forex, 100% virtual money.
          </div>
          <div
            style={{
              marginTop: 36,
