...
export default async function TradingPage() {
  ...
  return <>
    ...
    <p className="mb-8 mt-3 text-slate-400">These are separate copies of your accounts. Test trades change only these copies; your live app and imported snapshot stay unchanged. Execution prices come from the market feed. Pending orders and automatic stop-loss / take-profit execution are not running yet.</p>
